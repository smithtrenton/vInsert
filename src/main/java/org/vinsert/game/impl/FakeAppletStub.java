package org.vinsert.game.impl;


import org.vinsert.game.AppletConfiguration;
...
public final class FakeAppletStub implements AppletStub {
    ...
    public URL getDocumentBase() {
        try {
            ...
            throw new IllegalArgumentException("Invalid document base URL!", e);
        }
    }
    ...
    public URL getCodeBase() {
        try {
            ...
            throw new IllegalArgumentException("Invalid code base URL!", e);
        }
    }

...
import org.vinsert.api.Skills;
import org.vinsert.api.wrappers.Skill;

/**
 * API implementation for retrieving skill information.
 *
 * @author Cov
 * @see org.vinsert.api.Skills
 */
public final class SkillsImpl implements Skills {

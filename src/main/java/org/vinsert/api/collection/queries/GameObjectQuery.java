 ...
 *
 */
public final class GameObjectQuery extends SceneNodeQuery<GameObject, GameObjectQuery> {
    ...
    public List<GameObject> asList() {
        List<GameObject> all = filterSet(context.objects.getAll());
        Collections.sort(all, new Comparator<GameObject>() {
            @Override

...
import org.vinsert.gui.controller.SettingsDebugController;
 ...
 */
public final class SettingsDebugView extends JDialog implements ListSelectionListener {
    ...
    public SettingsDebugView(final SettingsDebugController settingsDebugController) {
        ...
        JScrollPane listScrollPane = new JScrollPane(settingsList);
        ...
        JScrollPane logAreaScrollPane = new JScrollPane(settingsLogArea);

 ...
 * @author A_C
 */
public final class WidgetTreeModel implements TreeModel {
    ...
    public int getIndexOfChild(Object parent, Object child) {
        ...
        } else if (parent instanceof WidgetTreeWrapper) {
    ...
    public static final class WidgetGroupTreeWrapper {
    ...
    public static final class WidgetTreeWrapper {
